...
export function generateMVPUserEmailTemplate(user: any) {
  return `
  <!DOCTYPE html>
  <html>
  <head>
  ...
  <body>
    <section class="email-main">
      ...
      <div class="content">
        <h2>Hello ${user?.name || "Valued Client"},</h2>
        <p>Thank you for contacting <strong>Thoughtwin</strong> for your MVP project estimation. We have received your request and our team will get in touch with you shortly with your personalized estimate and next steps.</p>
        <p>Meanwhile, if you would like to discuss your project directly, feel free to <a href="https://yourbookinglink.com">book a call with us here</a>.</p>
        <p>We appreciate your interest in working with Thoughtwin to bring your vision to life!</p>
