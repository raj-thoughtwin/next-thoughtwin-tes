...
export function generateSoftwareUserEmailTemplate(user: any) {
  return `
  <!DOCTYPE html>
  <html>
  <head>
  ...
  <body>
    <section class="email-main">
      ...
      <img src="cid:emailIcon" alt="Thank You Banner" style="width: 100%; height: 100px;" />
      ...
      <div class="content">
        ...
        <p>Thank you for reaching out to <strong>Thoughtwin</strong> for your software project estimation.</p>
        <p>We have successfully received your request and our team will reach out to you shortly with your personalized estimate and next steps.</p>
        <p>If you wish to expedite your project discussion, you can <a href="https://yourbookinglink.com">book a call with us now</a>.</p>
        <p>We appreciate your interest in working with Thoughtwin and look forward to helping you bring your software vision to life.</p>
