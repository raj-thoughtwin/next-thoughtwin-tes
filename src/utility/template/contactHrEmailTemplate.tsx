export function generateContactHrEmailTemplate(user: any) {
  return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
      ...
      <img src="cid:emailIcon" alt="Email Header" style="width: 100%; height: 100px;" />
        <div class="text-left">
          ...
          <p><strong>Full Name:</strong> ${user.fullName || user.fname + " " + user.lname || user.name}
          <br /><strong>Email:</strong> ${user.email}
          <br /><strong>Contact Number:</strong> ${user.phoneNumber || user.phone_number || user.phone}
          ${user.skypeWhatsapp ? `<br /><strong>Skype ID / Whatsapp No. :</strong> ${user.skypeWhatsapp}` : ""}
          <br /><strong>Message:</strong> ${user.description || user.message}
          ${user.services ? `<br /><strong>Service:</strong> ${user.services}` : ""}
          </p>
